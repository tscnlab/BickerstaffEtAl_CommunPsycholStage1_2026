...
- '3_pilot_settings.xlsx' is the spectral calibration file for the pilot light conditions. The spectra are kept constant at a target CCT of 5000K. A 0.3 ND filter was used for these calibration measurements as well as for the actual experiment. Here, only one round of measurements was made (six total, one for each light condition).
